...
import { CreateTask, DeleteTaskById, UpdateTaskById} from './api'
...
function TaskManager() {
  ...
  return (
    <div className = 'd-flex-column align-items-center w-50 m-auto mt-5'>
      ...
      <div className='input-group flex-grow-1'>
        ...
        className='form control' type='text' placeholder='Search Tasks'/>
      </div>
    </div>
    {/*List of items*/}
    <div className='d-flex flex-column w-100'>{
        tasks?.map((item) => (<div key = {item._id} className ='m-2 p-2 border bg-light w-100 rounded-3 d-flex justify-content-between align-items-center'>  
